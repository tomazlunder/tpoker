...
function insertRoundReturnId(id_room){
    return new Promise((resolve,reject) => {    
        var query = con.query("INSERT INTO round(fk_room) VALUE (?)",
            id_room,
            function(err, result){
                if (err) {
                    console.log(err)
...
function insertResult(id_round, id_person, hand, result){
    return new Promise((resolve,reject) => {    
        var query = con.query("INSERT INTO result(fk_round, fk_person, hand, result) VALUE (?,?,?,?)",
            [id_round,
                id_person,
                hand,
                result],
...
module.exports.insertRoundReturnId = insertRoundReturnId;
